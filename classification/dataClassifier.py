...
def enhancedPacmanFeatures(state, action):
    ...
    foodPellets = successor.getCapsules()
    ...
    #get 93% for contest without ghost but failing in sucide
    # score += 10.0 / (1.0 + len(newFood.asList())) + (10.0 /(1.0 + minfoodDist)) \
    #           + 10.0 / (10.0 + len(foodPellets))

    #get 93% + for both contest and sucide
    score += (20.0 /(1.0 + minfoodDist))

    features[action] = score
    return features
